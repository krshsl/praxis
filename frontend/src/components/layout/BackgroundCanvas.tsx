export function BackgroundCanvas() {
  const svg = `
<svg width="100%" height="100%" viewBox="0 0 2560 1920" fill="none" xmlns="http://www.w3.org/2000/svg" style="opacity: 0.4; pointer-events: none; width: 100%; height: 100%; object-fit: cover;">
  <g>
  ...
  <defs>
    ...
    <filter id="filter0_f_37_453-1" x="-200" y="-200" width="2000" height="2000" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
      <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
      <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
      <feGaussianBlur stdDeviation="50" result="effect1_foregroundBlur_37_453-1"></feGaussianBlur>
    </filter>
  </defs>
</svg>`
  ...
  return (
    <div className="fixed inset-0 pointer-events-none" style={{ zIndex: -1 }}>
      <div 
        ...
        style={{ 
          background: 'linear-gradient(135deg, var(--gray-2) 0%, var(--color-background) 100%)'
        }}
      />
      <div
        aria-hidden
        className="absolute right-0 top-1/2 left-2/3 transform -translate-y-1/2 flex items-center justify-center"
